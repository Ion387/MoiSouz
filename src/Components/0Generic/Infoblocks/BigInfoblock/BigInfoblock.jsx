...
<div className={s.icon}><Icon iconName={props.isVolumeGrow ? "growUpIcon" : "fallDownIcon"}/></div>

<div className={props.isVolumeGrow ? `${s.percent}` : `${s.percent} ${s.fall}`} >{props.percent}</div>
