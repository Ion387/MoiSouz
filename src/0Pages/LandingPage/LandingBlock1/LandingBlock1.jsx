    ...
    <div className={s.main}>
      <div className={s.section}>
        <LandingBlock1InfoSection
          ...
          text={"Ускоряет работу, повышает гибкость и оперативность действий"}
          iconName="landingDeadlineIcon"
        />
        <LandingBlock1InfoSection
          title={"Повышает уровень мотивации и вовлеченности участников"}
          text={
            "Геймификация, инструменты награждений участников за активную работу, краудсорсинг и краудфандинг"
          }
        ...
        <LandingBlock1InfoSection
          ...
          text={
            "Вследствие снижения уровня влияния альтернативных и радикальных организаций, а также диаспор"
          }
          iconName="landingHR"
        />
        <LandingBlock1InfoSection
