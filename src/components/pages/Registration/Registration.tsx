        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Typography variant="body1" className={s.bottomText}>
            ...
            <span>
              {' '}
              <a
                href={'/ПОЛЬЗОВАТЕЛЬСКОЕ_СОГЛАШЕНИЕ_САЙТА.pdf'}
                download={'ПОЛЬЗОВАТЕЛЬСКОЕ_СОГЛАШЕНИЕ_САЙТА.pdf'}
                target="_blank"
              >
                пользовательское соглашение,
              </a>{' '}
            </span>{' '}
            и получение информационных сообщений от группы компаний Мой Союз.
          </Typography>
        </form>
      </Paper>
      <Dialog
