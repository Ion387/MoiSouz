...
let text = {
    ...
    title2:"В Минздраве рассказали о разработке инновационных медицинских изделий",
    text1:"Новые композиты на основе золота и магнитных наночастиц для уничтожения раковых опухолей создали специалисты...",
...
<NavLink to="/news" className = {s.linkArea}>
</NavLink>
