        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-500 text-lg max-w-sm mb-6">
              Новый подход к заботе о членах профсоюза и цифровизации рутинных
              операций.
            </p>
            <button
          ...
          <div>
            ...
            <a
              ...
              className="text-primary-600 font-semibold hover:underline block mb-2"
            >
              souz365@bk.ru
            </a>
            <a
              href="tel:+7 (812) 985-64-20"
              className="text-primary-600 font-semibold hover:underline block mb-2"
            >
              +7 (812) 985-64-20
            </a>
            <div className="text-slate-400 text-sm mt-8">
              &copy; {new Date().getFullYear()} НашСоюз.
              <br />
              Все права защищены.
            </div>
          </div>
